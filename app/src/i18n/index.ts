...
const resources = {
  ...
  zh: {
    translation: {
      ...
      live: { title: '实时航班', subtitle: '实时飞机位置', region: '中国区域', aircraftCount: '飞机数', lastUpdate: '更新于', legend: '高度图例', highAlt: '>10 km', midHighAlt: '7–10 km', midAlt: '3–7 km', lowAlt: '<3 km', ground: '地面/未知', altitude: '高度', speed: '速度', heading: '航向', vrate: '垂直速率', origin: '出发国', viewAirline: '查看航司 →', unknownCallsign: '未知航班', disclaimer: '数据来自 OpenSky Network（ADS-B），约每 5 分钟刷新。覆盖率因地区而异，部分航班可能缺失。', error: '实时数据不可用', currentFlights: '当前航班', noFlights: '该航司当前无实时航班', noIcao: '无 ICAO 代码，无法匹配实时航班', viewLiveMap: '查看实时地图 →' },
