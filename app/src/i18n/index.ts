...
const resources = {
  en: {
    translation: {
      ...
      manufacturers: { title: 'Manufacturers', subtitle: 'Browse aircraft by builder', aircraftCount: 'aircraft' },
  ...
  zh: {
    translation: {
      ...
      manufacturers: { title: '制造商', subtitle: '按厂商浏览机型', aircraftCount: '款机型' },
